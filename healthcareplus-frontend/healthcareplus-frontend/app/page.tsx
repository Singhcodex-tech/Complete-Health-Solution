...
import { homeOfferTiles, faqs, partners } from "@/lib/data";
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden bg-paper">
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 px-5 pb-6 pt-5 sm:pb-10 sm:pt-8 md:px-8 md:pb-28 md:pt-20 lg:grid-cols-2">
          <motion.div
          ...
          >
            ...
            <h1 className="mt-3 font-display text-[30px] font-semibold leading-[1.12] text-ink sm:mt-4 sm:text-[42px] md:mt-6 lg:text-[52px]">
              Premium healthcare,
              <br />
              <span className="text-primary">delivered home.</span>
            </h1>

            <p className="mt-2.5 max-w-lg text-[14.5px] leading-relaxed text-ink-soft sm:mt-4 sm:text-[16px] md:mt-5">
            ...
            <form
              ...
              className="mt-4 flex flex-col gap-2.5 rounded-2xl border border-line bg-paper-raised p-2.5 shadow-lg shadow-ink/5 sm:mt-6 sm:flex-row md:mt-8"
            >
            ...
            <div className="mt-3 flex flex-wrap items-center gap-3 sm:mt-5 md:mt-6">
              <Link
                href="/booking"
          ...
          {/* Illustration / vitals card — desktop only */}
          <motion.div
            ...
            <div className="rounded-[28px] border border-line bg-paper-raised p-6 shadow-2xl shadow-ink/10">
              ...
              <div className="mt-3 flex items-center gap-3 rounded-xl border border-line p-3.5">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[12px] text-ink-soft">Dispatched to your location</p>
                </div>
              </div>
            </div>
      ...
      {/* SERVICES */}
      <section className="mx-auto max-w-7xl px-5 py-8 sm:py-14 md:px-8 md:py-20">
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 px-5 md:px-8 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-6">
              <div>
                <p className="font-display text-2xl font-semibold text-primary">2023</p>
                <p className="text-[13px] text-ink-soft">Founded in India</p>
              </div>
              <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="rounded-2xl border border-line p-6">
              <p className="font-display text-2xl font-semibold text-ink">120+</p>
          ...
          <div>
            ...
            <div className="mt-8 rounded-2xl border border-line p-6">
              ...
              <p className="mt-1 text-[13.5px] text-ink-soft">
                ...
                <span className="font-semibold text-primary">9631655055</span>
              </p>
            </div>
          </div>
          <ContactForm />
