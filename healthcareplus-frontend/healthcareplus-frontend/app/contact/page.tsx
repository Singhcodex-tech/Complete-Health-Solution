        ...
        <div className="space-y-4">
          <div className="flex items-center gap-4 rounded-2xl border border-line bg-paper-raised p-5">
            ...
            <div>
              ...
              <p className="text-[15px] font-semibold text-ink">9631655055</p>
            </div>
          </div>
          <div className="flex items-center gap-4 rounded-2xl border border-line bg-paper-raised p-5">
          ...
          >
            ...
            <div>
              ...
              <p className="text-[15px] font-semibold text-ink">+91 96316 55055</p>
            </div>
          </a>
          <div className="flex items-center gap-4 rounded-2xl border border-line bg-paper-raised p-5">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-primary-soft">
            ...
            <div>
              ...
              <p className="text-[15px] font-semibold text-ink">Serving 40+ cities, pan-India</p>
            </div>
          </div>
